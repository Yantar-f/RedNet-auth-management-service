...
//                        reg.getEncodedPassword().equals(expectedEncodedPassword) &&
//                        reg.getEmail().equals(expectedEmail) &&
//                        reg.getEncodedSecretWord().equals(expectedSecretWord) &&
...
//        expectedAccount.setID(Long.parseLong(expectedUserID));
//
//        RegistrationVerificationData expectedBody = new RegistrationVerificationData(
//                expectedRegistrationID,
//                expectedActivationCode
//        );
//
//        Registration expectedRegistration = new Registration(
//                id, expectedActivationCode,
//            expectedTokenID,
//            expectedUsername,
//            expectedEncodedPassword,
//            expectedEmail,
...
//        RegistrationVerificationData expectedBody = new RegistrationVerificationData(expectedRegistrationID, expectedActivationCode);
//
//        Registration expectedRegistration = new Registration(
//                id, "validCode",
